# install-x86_64-apple-darwin.cmake
...
file(INSTALL
  ...
  TYPE FILE
  FILES
    "${LLVM_INSTALL_DIR}/lib/clang/21/lib/darwin/libflang_rt.runtime.a"
)

# drop arch tag
configure_file(
    "${LLVM_INSTALL_DIR}/lib/clang/21/lib/darwin/libclang_rt.osx.a"
    "${PACKAGE_PREFIX}/lib/libclang_rt.osx.a"
    COPYONLY
)
...
file(INSTALL
  ...
  FILES
    ...
    "${LLVM_INSTALL_DIR}/lib/libgomp.1.dylib"
    "${LLVM_INSTALL_DIR}/lib/libgomp.dylib"
    "${LLVM_INSTALL_DIR}/lib/libiomp5.dylib"
    "${LLVM_INSTALL_DIR}/lib/libomp.dylib"
)
